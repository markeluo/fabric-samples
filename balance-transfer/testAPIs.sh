...
ORG1_TOKEN=$(curl -s -X POST \
  ...
  -d 'username=markeluo&orgName=org1')
echo $ORG1_TOKEN
...
#   http://localhost:4000/channels/mychannel/chaincodes/mytest \
#   -H "authorization: Bearer $ORG1_TOKEN" \
#   -H "content-type: application/json" \
#   -d '{
# 	"fcn":"invoke",
...
# echo
# curl -s -X GET \
#   "http://localhost:4000/channels/mychannel/chaincodes/mytest?peer=peer1&fcn=query&args=%5B%22a%22%5D" \
#   -H "authorization: Bearer $ORG1_TOKEN" \
#   -H "content-type: application/json"
# echo
# echo
